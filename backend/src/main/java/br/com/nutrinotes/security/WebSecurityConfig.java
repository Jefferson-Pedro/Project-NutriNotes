...
public class WebSecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.authorizeHttpRequests( (auth) -> {
			...
			.requestMatchers(new  AntPathRequestMatcher("/media/**", "POST")).permitAll()
			...
			.requestMatchers(new  AntPathRequestMatcher("/media/**", "GET")).permitAll()
			...
			.requestMatchers(new  AntPathRequestMatcher("/media/**", "DELETE")).permitAll()
