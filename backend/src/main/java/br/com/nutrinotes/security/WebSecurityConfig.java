...
public class WebSecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.authorizeHttpRequests( (auth) -> {
			...
			.requestMatchers(new  AntPathRequestMatcher("/midia/**", "POST")).permitAll()
			...
			.requestMatchers(new  AntPathRequestMatcher("/midia/**", "GET")).permitAll()
			...
			.requestMatchers(new  AntPathRequestMatcher("/midia/**", "DELETE")).permitAll()
			...
			.requestMatchers(new  AntPathRequestMatcher("/midia/edit/{id}", "PUT")).permitAll()
